...
//       {/* <div 
//         ref={loaderRef} 
//         className="fixed w-full h-full bg-black z-50 top-0 transition-all duration-700 flex items-center justify-center"
//       >
//         <h1 className="absolute text-4xl md:text-4xl bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent opacity-0 animate-[load_1s_linear_1s]">
//           Loading.
//         </h1>
//         <h1 className="absolute text-4xl md:text-4xl bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent opacity-0 animate-[load_1s_linear_2s]">
//           Loading..
//         </h1>
//         <h1 className="absolute text-4xl md:text-4xl bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent opacity-0 animate-[load_1s_linear_3s]">
//           Loading...
//         </h1>
//       </div> */}
...
//       <div 
//         ref={fixedImageRef} 
//         className="hidden fixed h-[30vw] w-[24vw] rounded-2xl z-40 left-1/2 top-1/4 bg-cover bg-center"
//       ></div>

//       <div ref={mainRef} className="relative z-10">
//         {/* Page 1 */}
//         <div className="min-h-screen w-full bg-[#efeae3] relative px-2 md:px-8">
//           {/* Navbar */}
//           {/* <div className="max-h-[2px] h-4">
//             <Navbar />
//           </div> */}

//           {/* Center Content */}
//           <div className="h-[65vh] w-full flex flex-col-reverse md:flex-row md:items-end justify-between border-b border-black/25 pb-10 md:pb-16 px-5 md:px-0 relative z-10">
//             <div className="md:w-1/4 w-4/5">
//               <h3 className="text-[5.5vw] md:text-[1.8vw] leading-[6vw] md:leading-[2vw]">
...
//             </div>
//             <div>
//               <h1 className=" font-roashe font-bold md:text-7xl lg:text-8xl text-right leading-[15vw] md:leading-[7vw] ">
//                 LET <br />
//                 SATISFACTION <br />
//                 PREVAIL
//               </h1>
...
//           {/* Hero Shape */}
//           <div className="absolute w-[46vw] h-[36vw] right-0 top-[65vh] opacity-90">
//             <div className="absolute bg-[#fe320a] h-full w-full rounded-l-full blur-md"></div>
//             <div className="absolute bg-gradient-to-br from-[#fe320a] to-[#fe3f0a] h-[30vw] w-[30vw] rounded-full blur-[25px] animate-[anime2_5s_linear_infinite_alternate]"></div>
//             <div className="absolute bg-gradient-to-br from-[#fe320a] to-[#fe3f0a] h-[30vw] w-[30vw] rounded-full blur-[25px] animate-[anime1_5s_linear_infinite_alternate]"></div>
//           </div>
...
//             muted 
//             src="./novax7.mp4"
//             className="relative rounded-lg md:rounded-3xl mt-4 md:mt-16 w-[92%] md:w-full ml-[4%] md:ml-0 h-[70vh] md:h-auto object-cover md:object-contain"
//           ></video>
//         </div>
...
//           <div className="h-[90vh] md:h-[80vh] w-full p-10 md:p-18 flex flex-col md:flex-row md:items-center justify-between relative z-10">
//             <h1 className="text-[8.2vw] md:text-4xl w-full md:w-3/5 leading-[9vw] md:leading-[4vw]">
...
//               and so on.
//             </h1>
//             <div className="w-[70%] md:w-1/5">
//               <img src="/img/23.jpg" className="w-full rounded-2xl" />
//               <p className="font-extralight mt-8 text-[3vw] md:text-base">
...
//         {/* Page 3 */}
//         <div className="min-h-screen w-full bg-[#efeae3] py-16">
//           <p className="text-6xl ml-5 mb-4">Our Events</p>
//           <div id="elem-container">
//             <div
//               className="elem h-[150px] w-full relative border-b border-[#38383864] overflow-hidden flex items-center px-8"
...
//               <h2 className="text-3xl md:text-[3vw] relative z-10">Creations</h2>
//             </div>
//             <div
//               className="elem h-[150px] w-full relative border-b border-[#38383864] overflow-hidden flex items-center px-8"
...
//             >
//               <div className="overlay absolute h-full w-full bg-orange-500 left-0 top-[-100%] transition-all duration-250 ease-in"></div>
//               <h2 className="text-3xl md:text-[3vw] relative z-10">Samarpan</h2>
//             </div>
//             <div
//               className="elem h-[150px] w-full relative border-b border-[#38383864] overflow-hidden flex items-center px-8"
...
//             >
//               <div className="overlay absolute h-full w-full bg-orange-500 left-0 top-[-100%] transition-all duration-250 ease-in"></div>
//               <h2 className="text-3xl md:text-[3vw] relative z-10">Graffiti</h2>
//             </div>
//             <div
//               className="elem h-[150px] w-full relative border-b border-[#38383864] overflow-hidden flex items-center px-8"
...
//             >
//               <div className="overlay absolute h-full w-full bg-orange-500 left-0 top-[-100%] transition-all duration-250 ease-in"></div>
//               <h2 className="text-3xl md:text-[3vw] relative z-10">Shades</h2>
//             </div>
//             <div
//               className="elem h-[150px] w-full relative border-b border-[#38383864] overflow-hidden flex items-center px-8"
...
//             >
//               <div className="overlay absolute h-full w-full bg-orange-500 left-0 top-[-100%] transition-all duration-250 ease-in"></div>
//               <h2 className="text-3xl md:text-[3vw] relative z-10">Face off</h2>
//             </div>
//             <div
//               className="elem h-[150px] w-full relative border-b border-[#38383864] overflow-hidden flex items-center px-8"
...
//             >
//               <div className="overlay absolute h-full w-full bg-orange-500 left-0 top-[-100%] transition-all duration-250 ease-in"></div>
//               <h2 className="text-3xl md:text-[3vw] relative z-10">Insignia</h2>
//             </div>
//             <div
//               className="elem h-[150px] w-full relative border-b border-[#38383864] overflow-hidden flex items-center px-8"
...
//             >
//               <div className="overlay absolute h-full w-full bg-orange-500 left-0 top-[-100%] transition-all duration-250 ease-in"></div>
//               <h2 className="text-3xl md:text-[3vw] relative z-10">Akriti</h2>
//             </div>
//             <div
//               className="elem h-[150px] w-full relative border-b border-[#38383864] overflow-hidden flex items-center px-8"
...
//             >
//               <div className="overlay absolute h-full w-full bg-orange-500 left-0 top-[-100%] transition-all duration-250 ease-in"></div>
//               <h2 className="text-3xl md:text-[3vw] relative z-10">Sketchers Saturday</h2>
//             </div>
//           </div>
//         </div>

//         {/* Page 4 */}
//         <div className="h-[70vh] w-full bg-[#efeae3] py-10 px-2 md:px-8 md:py-40">
//           <div className="swiper mySwiper h-full w-full">
//             <div className="swiper-wrapper">
//               <div className="swiper-slide w-[30%] border-l border-[#aeadad] px-2 md:px-8">
//                 <h1 className="text-3xl font-bold">Samarpan:</h1>
//                 <br />
//                 <p>
...
//               </div>
//               <div className="swiper-slide w-[30%] border-l border-[#aeadad] px-2 md:px-8">
//                 <h1 className="text-3xl font-bold">Akriti:</h1>
//                 <br />
//                 <p>
...
//               </div>
//               <div className="swiper-slide w-[30%] border-l border-[#aeadad] px-2 md:px-8">
//                 <h1 className="text-3xl font-bold">Graffiti:</h1>
//                 <br />
//                 <p>
...
//               </div>
//               <div className="swiper-slide w-[30%] border-l border-[#aeadad] px-2 md:px-8">
//                 <h1 className="text-3xl font-bold">Face-Off:</h1>
//                 <br />
//                 <p>
...
//         {/* Full Screen Menu */}
//         {/* <div ref={fullScrRef} className="fixed h-screen w-full bg-black/70 z-40 top-[-100%] transition-all duration-500 ease-in-out">
//           <div className="h-1/2 w-full bg-[#efeae3] rounded-b-xl"></div>
//         </div> */}
//       </div>

//       {/* Footer */}
//       {/* <div className="fixed h-[105vh] w-full bg-black text-white z-[9] bottom-0 flex justify-end flex-col px-3 md:px-12 py-4">
//         <Footer />
//       </div> */}

//       {/* Custom Animation Keyframes - these would need to be added to tailwind.config.js */}
//       <style jsx>{`
//         @keyframes load {
//           0% { opacity: 0; }
//           10% { opacity: 1; }
