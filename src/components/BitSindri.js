...
//             ></script>
//             <spline-viewer
//               url="https://prod.spline.design/8oM8iGXNvg7ST-Sv/scene.splinecode"
...
// File: src/components/BitSindri.js
...
// const BitSindri = () => {
//   return (
//     <div className='w-full absolute flex flex-col min-h-screen bg-white '>
...
export default function BitSindri() {

  return (
    <div className='w-full bg-white overflow-hidden z-20'>
